...
export default class Gui {
	...
	build() {
		...
		audioFolder.addBinding(params.audio, 'floor', { min: 0, max: 0.6, step: 0.01 })
		audioFolder.addBinding(params.audio, 'bpmSlow', { min: 50, max: 140, step: 1 })
		audioFolder.addBinding(params.audio, 'bpmFast', { min: 90, max: 220, step: 1 })
		audioFolder.addBinding(params.audio, 'rateMin', { min: 0.3, max: 1, step: 0.05 })
		audioFolder.addBinding(params.audio, 'rateMax', { min: 1, max: 2.5, step: 0.05 })
